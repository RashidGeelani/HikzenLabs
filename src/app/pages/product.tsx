...
export function ProductsPage({ onNavigate }: ProductsPageProps) {
  ...
  useEffect(() => {
    ...
    if (cachedCount) setWaitlistCount(Number(cachedCount));
...
const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
  ...
  const submitted = JSON.parse(localStorage.getItem("waitlist_emails") || "[]");
  ...
  try {
    ...
    if (data.status === "success") {
      ...
      localStorage.setItem("waitlist_emails", JSON.stringify(submitted));
      setSuccess(true);
            ...
            {[
              {
                ...
                description: "Custom AI products designed for enterprise-scale operations",
              },
              {
                icon: Rocket,
                title: "AI SaaS Apps",
                description: "AI-powered SaaS applications designed for automation",
              },
            ].map((product, index) => {
